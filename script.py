...
# 1. Write a program to print individual items of a list.
...
# 2. Write a program to add an item (entered by the user) to the end of the list.
...
# 3. Write a program to calculate the product of list items.
